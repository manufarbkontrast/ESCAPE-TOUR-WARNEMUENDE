    ...
    <div className="w-full">
      ...
      <section className="container-custom py-20 md:py-28">
        <div className="max-w-2xl">
          <h1 className="font-display text-5xl leading-[1.05] text-coast-ink md:text-6xl">
            Häufige Fragen
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-coast-muted">
            Was uns vor einer Buchung am häufigsten erreicht. Steht eure Frage nicht dabei, ruft an
            oder schreibt uns — wir antworten in der Regel am selben Tag.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-12 lg:grid-cols-[1.4fr_0.6fr] lg:gap-16">
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            <div className="card">
              <h2 className="text-xl font-bold text-coast-ink">Noch etwas offen?</h2>
              <p className="mt-3 text-base leading-relaxed text-coast-ink/65">
                Gerade bei Gruppen, Firmenfeiern oder knappen Zeitfenstern lohnt sich ein kurzer
                Anruf.
              </p>

              <dl className="mt-6 space-y-4 border-t border-coast-line pt-6">
                <div>
                  <dt className="font-mono text-[0.65rem] uppercase tracking-[0.18em] text-coast-muted">
                    Telefon
                  </dt>
                  <dd className="mt-1">
                    <a
                      href={telHref(SITE.phone.display)}
                      className="font-mono text-lg tabular-nums text-coast-ink hover:text-coast-sea"
                    >
                      {SITE.phone.display}
                    </a>
                    <div className="mt-0.5 text-sm text-coast-muted">{SITE.phone.hours}</div>
                  </dd>
                </div>
                ...
                <div>
                  ...
                  <dd className="mt-1">
                    <a
                      ...
                      className="break-all text-base text-coast-ink hover:text-coast-sea"
                    >
                      {SITE.email}
                    </a>
                  </dd>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-base text-coast-ink">
                    {SITE.meetingPoint.name}
                    <div className="text-sm text-coast-muted">{SITE.meetingPoint.detail}</div>
                  </dd>
                </div>
              </dl>
        ...
        <div className="mt-16 border-t border-white/[0.06] pt-12">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <p className="max-w-xl text-lg text-coast-muted">
