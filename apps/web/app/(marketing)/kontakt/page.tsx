...
function ContactInfoCard({ item }: { readonly item: ContactInfoItem }) {
  const content = (
    <div className="flex items-start gap-4">
      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-coast-panel text-coast-ink">
        {item.icon}
      </div>
      <div>
        <h3 className="text-sm font-semibold text-coast-muted">{item.label}</h3>
        <p className="mt-1 text-coast-muted">{item.value}</p>
      </div>
    </div>
  )
  ...
  if (item.href) {
    return (
      <a href={item.href} className="card-hover block hover:text-coast-ink transition-colors">
        {content}
      </a>
    )
  }
        ...
        <div className="container-custom relative py-20 md:py-28">
          <div className="mx-auto max-w-3xl text-center space-y-6">
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold">
              <span className="text-coast-sea">Kontakt</span>
            </h1>
            <p className="text-lg md:text-xl text-coast-muted max-w-2xl mx-auto">
              Habt ihr Fragen zu unseren Touren, wollt eine Gruppenanfrage stellen oder uns einfach
              Feedback geben? Wir freuen uns auf eure Nachricht.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-coast-paper">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Left: Contact Form */}
            <div>
              <h2 className="text-2xl font-bold text-coast-ink mb-6">Schreibt uns</h2>
           ...
           Server-HTML. Siehe __tests__/app/marketing/suspense-grenzen.test.tsx */}
            ...
            <div>
              <h2 className="text-2xl font-bold text-coast-ink mb-6">So erreicht ihr uns</h2>
              ...
              <div className="mt-8 card-hover overflow-hidden">
                <div className="aspect-video bg-coast-panel flex items-center justify-center rounded-lg">
                  <div className="text-center space-y-3">
                    <svg
                      className="h-12 w-12 mx-auto text-coast-ink"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                    ...
                    <p className="text-coast-muted text-sm">Am Leuchtturm 1, 18119 Warnemünde</p>
                    <a
