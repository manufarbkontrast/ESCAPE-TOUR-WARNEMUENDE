  ...
  >
   ...
   <div className="flex flex-col flex-1 space-y-6">
    ...
    <div className="flex items-baseline gap-2">
     ...
     <span className="text-white/60">pro Person</span>
    </div>
...
function IncludedCard({ item }: { readonly item: IncludedItem }) {
 return (
  <div className="card-hover text-center space-y-4">
   ...
   <p className="text-sm text-white/70 font-semibold">{item.description}</p>
  </div>
 );
}
       ...
       <div className="space-y-4">
        <div className="grid sm:grid-cols-2 gap-4">
         <div className="rounded-xl bg-dark-800/50 border border-dark-700 p-6">
          ...
          <p className="text-white/70 font-semibold mt-2">ab 6 Personen</p>
         </div>
         <div className="rounded-xl bg-dark-800/50 border border-dark-700 p-6">
          <div className="font-display text-3xl font-bold text-white">
           15%
          </div>
          <p className="text-white/70 font-semibold mt-2">ab 10 Personen</p>
         </div>
        </div>
