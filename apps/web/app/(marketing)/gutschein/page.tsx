    ...
    <div className="grid gap-12 lg:grid-cols-[1fr_0.9fr] lg:gap-16">
     <div>
      <h1 className="font-display text-4xl leading-[1.05] text-white md:text-6xl">
       ...
       <span className="mt-1 block text-white/60">nicht noch einen Gegenstand</span>
      </h1>
      <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/75">
       Zwölf Rätselstationen durch Warnemünde, vom Leuchtturm über die Westmole
       bis zum Alten Strom. Das iPad bekommen sie von uns — mitzubringen sind
       nur Schuhe, in denen sich ein paar Kilometer laufen lässt.
      </p>
      ...
      <div className="mt-12 border-t border-white/[0.06] pt-8">
       <h2 className="text-lg font-bold text-white">So läuft es ab</h2>
       <ol className="mt-4 space-y-3 text-base leading-relaxed text-white/65">
        <li className="flex gap-3">
         <span className="font-mono text-sm text-neon-400">01</span>
         Tour und Personenzahl wählen, bezahlen.
        </li>
        <li className="flex gap-3">
         <span className="font-mono text-sm text-neon-400">02</span>
         Ihr bekommt den Gutschein per E-Mail und gebt ihn weiter.
        </li>
        <li className="flex gap-3">
         <span className="font-mono text-sm text-neon-400">03</span>
         Die beschenkte Person löst den Code auf{' '}
         <Link href="/buchen" className="text-neon-300 underline-offset-4 hover:underline">
          der Buchungsseite
         </Link>{' '}
