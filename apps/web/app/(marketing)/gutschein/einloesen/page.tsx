    ...
    <div className="w-full">
      <section className="container-custom py-16 md:py-24">
        <div className="grid gap-12 lg:grid-cols-[1fr_0.9fr] lg:gap-16">
          <div>
            <h1 className="font-display text-4xl leading-[1.05] text-coast-ink md:text-5xl">
              Gutschein einlösen
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-coast-ink/75">
              Code eingeben, Tag aussuchen, fertig. Die Tour ist bereits bezahlt — es geht nur noch
              darum, wann ihr loslaufen wollt.
            </p>

            <div className="mt-10 border-t border-white/[0.06] pt-8">
              <h2 className="text-lg font-bold text-coast-ink">Was danach passiert</h2>
              <p className="mt-3 max-w-xl text-base leading-relaxed text-coast-ink/65">
                Ihr bekommt einen Startcode per E-Mail. Damit kommt ihr{' '}
                {SITE.meetingPoint.minutesBefore} Minuten vor eurem Termin zu{' '}
                {SITE.meetingPoint.name} {SITE.meetingPoint.detail}, bekommt das iPad und eine kurze
                Einweisung. Dann läuft die Zeit.
              </p>
            </div>
            ...
            <p className="mt-4 text-sm text-coast-muted">
              Noch keinen Gutschein?{' '}
              <Link href="/gutschein" className="text-coast-sea underline-offset-4 hover:underline">
                Hier verschenken
              </Link>
              .
            </p>
