    ...
    <div className="w-full">
      <section className="container-custom py-20 md:py-28">
        <div className="mx-auto max-w-2xl">
          <svg
            className="h-12 w-12 text-coast-sea"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
          ...
          <h1 className="mt-6 font-display text-4xl leading-[1.1] text-coast-ink md:text-5xl">
            Danke — der Gutschein ist unterwegs
          </h1>

          <p className="mt-6 text-lg leading-relaxed text-coast-ink/75">
            Wir schicken ihn in den nächsten Minuten an die E-Mail-Adresse, die ihr bei der Zahlung
            angegeben habt. Darin steht der Gutscheincode, die Tour, die Personenzahl und wie er
            eingelöst wird.
          </p>

          <div className="card mt-10">
            <h2 className="text-lg font-bold text-coast-ink">Nichts angekommen?</h2>
            <p className="mt-3 text-base leading-relaxed text-coast-ink/65">
              Schaut zuerst im Spam-Ordner nach. Wenn nach einer halben Stunde immer noch nichts da
              ist, meldet euch — wir finden die Zahlung und schicken den Gutschein erneut.
            </p>
            <div className="mt-5 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href={mailHref(SITE.email, 'Gutschein nicht angekommen')}
