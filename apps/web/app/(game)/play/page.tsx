  ...
  <div className="flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center px-4">
   ...
   >
    ...
    <div className="text-center">
     ...
     <p className="mt-2 text-white/60 font-semibold text-sm">{labels.subtitle}</p>
    </div>

    {/* Code input card */}
    <div className="card p-8">
     <label className="mb-5 block text-center text-xs font-semibold text-white/60 uppercase tracking-wide">
      {labels.inputLabel}
     </label>
