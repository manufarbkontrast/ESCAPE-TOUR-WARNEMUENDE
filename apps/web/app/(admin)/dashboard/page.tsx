   ...
   <table className="w-full text-left">
    ...
    <tbody>
     {bookings.map((b) => (
      ...
      >
       <td className="py-3 px-4 font-mono text-sm text-white font-semibold">{b.booking_code}</td>
  ...
  <div>
   ...
   >
    <div className="px-5 py-4 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.04)' }}>
     <h2 className="text-sm font-semibold text-white/80">Letzte Buchungen</h2>
    </div>
