...
export const DEMO_STATIONS: readonly Station[] = [
  // ── 1. Leuchtturm (Start) ────────────────────────────────────────────
  {
    ...
    radiusMeters: 50,
    introTextDe:
      'Willkommen am Leuchtturm von Warnemünde! Seit 1898 weist er Schiffen den Weg in den Hafen. Hier beginnt eure Reise auf den Spuren des Lotsenkapitäns Friedrich Scheel.',
    introTextEn:
    ...
    storyTextDe:
      'Im Jahr 1923 verschwand Kapitän Scheel spurlos. Sein letzter Eintrag im Logbuch lautete: "Die Wahrheit liegt in den Stufen." Was meinte er damit? Schaut euch den Leuchtturm genau an...',
    storyTextEn:
    ...
    completionTextDe:
      'Ausgezeichnet! Ihr habt das erste Rätsel gelöst. Kapitän Scheel hinterließ weitere Hinweise — direkt nebenan, im Teepott.',
    completionTextEn:
      'Excellent! You solved the first puzzle. Captain Scheel left more clues — right next door, at the Teepott.',
    transitionTextDe:
      'Scheel verließ den Leuchtturm bei Einbruch der Dämmerung. Sein nächstes Ziel lag nur wenige Schritte entfernt — das Gebäude mit dem unverwechselbaren Wellendach. Er nannte es "den Schlüssel zur Verschlüsselung".',
    transitionTextEn:
    ...
    walkingHintDe: 'Schaut nach links — das geschwungene Dach ist nicht zu übersehen.',
  ...
  // ── 2. Teepott ───────────────────────────────────────────────────────
  {
    ...
    radiusMeters: 50,
    introTextDe:
      'Der Teepott — Warnemündes ikonischstes Bauwerk. 1968 errichtet, ist sein hyperbolisches Schalendach weltweit einzigartig. Die Wellenform inspirierte nicht nur Architekten...',
    introTextEn:
    ...
    storyTextDe:
      'Was kaum jemand weiß: Kapitän Scheel war fasziniert von der Tierwelt an der Küste. In seinem Logbuch notierte er: "Der Vogel auf dem Dach ist mein Bote — er trägt meine Nachrichten über das Meer." Schaut genau hin: Welches Tier thront auf der Wetterfahne des Teepotts?',
    storyTextEn:
    ...
    completionTextDe:
      'Sehr gut! Die Möwe war Scheels Symbol für Freiheit. Jetzt geht es raus aufs Meer — zur Westmole!',
    completionTextEn:
      'Very good! The seagull was Scheel\'s symbol of freedom. Now head out to sea — to the West Pier!',
    transitionTextDe:
      'Scheel ging oft bei Sturm zur Westmole. "Nur dort", schrieb er, "wo das Meer am lautesten ist, kann man ungestört denken." Folgt der Promenade nach Nordwesten — der lange Steg führt weit hinaus.',
    transitionTextEn:
  ...
  // ── 3. Westmole ──────────────────────────────────────────────────────
  {
    ...
    radiusMeters: 50,
    introTextDe:
      'Die Westmole — der lange Steg, der weit hinaus in die Ostsee führt. Am Ende leuchtet das grüne Molenfeuer und weist den Schiffen den Weg in den Hafen.',
    introTextEn:
    ...
    storyTextDe:
      'Am Abend seines Verschwindens wurde Scheel zuletzt auf der Westmole gesehen. Fischer berichten, er habe am grünen Leuchtfeuer etwas in den Stein geritzt — eine Jahreszahl, die ihm alles bedeutete. Findet ihr sie?',
    storyTextEn:
    ...
    completionTextDe:
      'Gut gemacht! Die Jahreszahl war der Schlüssel. Scheels Spuren führen nun zurück an Land — zum eleganten Kurhaus.',
    completionTextEn:
      'Well done! The year was the key. Scheel\'s trail now leads back to land — to the elegant Kurhaus.',
    transitionTextDe:
      'Scheel kehrte von der Mole zurück und bog nach Süden ab. Im Kurhaus fand in jener Nacht ein großer Ball statt — sein letzter öffentlicher Auftritt. Die Ornamente im Ballsaal verbargen mehr als nur Dekoration.',
    transitionTextEn:
    ...
    walkingHintDe: 'Geht die Mole zurück und haltet euch links Richtung Seestraße.',
    walkingHintEn: 'Walk back along the pier and keep left toward Seestraße.',
    headerImageUrl: null,
    backgroundAudioUrl: null,
    ambientSound: 'waves',
    estimatedDurationMinutes: 10,
  ...
  // ── 4. Kurhaus ────────────────────────────────────────────────────────
  {
    ...
    storyTextDe:
      'Im Ballsaal des Kurhauses fand Scheels letzter öffentlicher Auftritt statt. Augenzeugen berichten, er habe die Fassade studiert und dabei gemurmelt: "Eine Seekarte, verborgen in der Schönheit." Über dem Eingangsportal steht eine Inschrift mit einer Jahreszahl — das Erbaujahr dieses prächtigen Gebäudes. Welche vierstellige Zahl findet ihr dort?',
    storyTextEn:
    ...
    completionTextDe:
      'Perfekt! 1928 — das Jahr, in dem Scheels Vermächtnis in Stein gemeißelt wurde. Der nächste Hinweis liegt am Strand — zwischen Sand und Meer.',
    completionTextEn:
      'Perfect! 1928 — the year Scheel\'s legacy was carved in stone. The next clue lies at the beach — between sand and sea.',
    transitionTextDe:
      'Scheel verließ den Ball durch den Seiteneingang. Er wurde gesehen, wie er über die Dünen zum Strand ging — hastig, als hätte er nicht viel Zeit. Dort soll er etwas vergraben haben.',
    transitionTextEn:
    ...
    walkingHintDe: 'Geht Richtung Strand — ihr seht die Dünen bereits.',
  ...
  // ── 5. Strand ─────────────────────────────────────────────────────────
  {
    ...
    radiusMeters: 50,
    introTextDe:
      'Der breite Sandstrand von Warnemünde ist einer der schönsten an der Ostsee. Doch unter dem Sand verbirgt sich mehr als nur Muscheln...',
    introTextEn:
    ...
    storyTextDe:
      'Fischer berichten von einer alten Truhe, die bei Sturmfluten manchmal freigespült wird. Auf dem Deckel ist ein Zahlenschloss mit vier Ziffern. Die Kombination ist das Gründungsjahr des Leuchtturms — ein Schlüssel zur Vergangenheit.',
    storyTextEn:
    ...
    completionTextDe:
      'Die Truhe öffnet sich! Darin liegt eine alte Seekarte mit einem markierten Ort — der Kirchplatz. Eilt dorthin!',
    completionTextEn:
      'The chest opens! Inside lies an old nautical chart with a marked location — the church square. Hurry there!',
    transitionTextDe:
      'In der Truhe lag neben der Seekarte ein vergilbter Zettel: "Die Kirche bewahrt, was die See vergessen hat." Scheel hatte dort etwas hinterlegt — im ältesten Gebäude des Ortes. Geht landeinwärts zum Kirchplatz.',
    transitionTextEn:
    ...
    walkingHintDe: 'Verlasst den Strand landeinwärts und folgt der Kirchenstraße.',
    walkingHintEn: 'Leave the beach heading inland and follow Kirchenstraße.',
    headerImageUrl: null,
    backgroundAudioUrl: null,
    ambientSound: 'waves',
    estimatedDurationMinutes: 10,
  ...
  // ── 6. Kirchplatz ─────────────────────────────────────────────────────
  {
    ...
    radiusMeters: 50,
    introTextDe:
      'Die Warnemünder Kirche steht seit dem 15. Jahrhundert im Zentrum des Ortes. An ihrem Portal findet sich ein uraltes Symbol, das auch Kapitän Scheel in seinem Testament erwähnte.',
    introTextEn:
    ...
    storyTextDe:
      'Scheels Testament endet mit den Worten: "Sucht das Zeichen an der Kirchentür. Es ist das Symbol der Seefahrer — es hat mich mein Leben lang begleitet. Wer es benennt, enthüllt mein letztes Geheimnis."',
    storyTextEn:
    ...
    completionTextDe:
      'Richtig — der Anker! Scheels Symbol. Doch sein Vermächtnis ist noch nicht vollständig enthüllt. Im Heimatmuseum nebenan liegen weitere Stücke des Puzzles.',
    completionTextEn:
    ...
    transitionTextDe:
      'Hinter dem Kirchplatz, in der Alexandrinenstraße, steht das älteste Fischerhaus des Ortes — heute das Heimatmuseum. Scheel soll dort ein Inventarverzeichnis hinterlassen haben, in dem eine Nachricht verborgen ist.',
    transitionTextEn:
      'Behind the church square, on Alexandrinenstraße, stands the oldest fisherman\'s house in town — now the local museum. Scheel is said to have left an inventory there with a hidden message.',
    walkingHintDe: 'Das Museum ist gleich um die Ecke in der Alexandrinenstraße.',
    walkingHintEn: 'The museum is just around the corner on Alexandrinenstraße.',
    headerImageUrl: null,
    backgroundAudioUrl: null,
  ...
  // ── 7. Heimatmuseum ───────────────────────────────────────────────────
  {
    ...
    radiusMeters: 50,
    introTextDe:
      'Das Heimatmuseum — untergebracht im ältesten Fischerhaus von 1767. Niedrige Decken, knarrende Dielen und der Geruch von Geschichte. Hier hat Scheel etwas versteckt.',
    introTextEn:
    ...
    storyTextDe:
      'In einem vergessenen Inventarverzeichnis des Museums finden sich seltsame Einträge: "Leuchtturm, Ostsee, Teepott, Segel, Ebbe." Die Anfangsbuchstaben ergeben ein Wort — Scheels wahre Berufung. Welches Wort ist es?',
    storyTextEn:
    ...
    completionTextDe:
      'LOTSE — natürlich! Das war Scheels Berufung, sein ganzes Leben. Das Inventar enthält einen weiteren Hinweis: eine Adresse in der Alexandrinenstraße. Die Vogtei — Warnemündes ältestes Gebäude.',
    completionTextEn:
      'PILOT — of course! That was Scheel\'s calling, his whole life. The inventory contains another clue: an address on Alexandrinenstraße. The Vogtei — Warnemuende\'s oldest building.',
    transitionTextDe:
    ...
    walkingHintDe: 'Nur wenige Meter weiter die Alexandrinenstraße hinunter.',
    walkingHintEn: 'Just a few meters further down Alexandrinenstraße.',
    headerImageUrl: null,
    backgroundAudioUrl: null,
    ambientSound: 'wind',
    estimatedDurationMinutes: 10,
  ...
  // ── 8. Vogtei ─────────────────────────────────────────────────────────
  {
    ...
    radiusMeters: 50,
    introTextDe:
      'Die Vogtei — das älteste Gebäude Warnemündes, erbaut um 1300. Einst Zollstation, dann Amtsgericht, heute ein Zeuge vergangener Jahrhunderte. An der Fassade finden sich uralte Siegel.',
    introTextEn:
    ...
    storyTextDe:
      'Scheel schmuggelte Nachrichten durch die Zollstation — versteckt in den Siegelabdrücken. An der Fassade sind fünf Siegel zu sehen. Jedes steht für eine Zahl. Bringt sie in die richtige Reihenfolge: Anker=1, Kreuz=2, Stern=3, Welle=4, Krone=5. Die Reihenfolge von links nach rechts ergibt den Code.',
    storyTextEn:
    ...
    transitionTextDe:
      'Edvard Munch — der berühmte norwegische Maler — lebte 1907 bis 1908 in Warnemünde. Sein Haus steht nur wenige Schritte entfernt Am Strom. Munch und Scheel waren Freunde. In einem Gemälde versteckte Munch Koordinaten — ein Gefallen für den Kapitän.',
    transitionTextEn:
      'Edvard Munch — the famous Norwegian painter — lived in Warnemünde from 1907 to 1908. His house stands just a few steps away on Am Strom. Munch and Scheel were friends.',
  ...
  // ── 9. Edvard-Munch-Haus ──────────────────────────────────────────────
  {
    ...
    subtitleDe: 'Kunst und Verschwörung',
    subtitleEn: 'Art and conspiracy',
    location: { lat: 54.1773, lng: 12.0850 },
    locationName: 'Edvard-Munch-Haus, Am Strom 53',
    radiusMeters: 50,
    introTextDe:
      'Am Strom 53 — hier lebte der norwegische Maler Edvard Munch von 1907 bis 1908. Was wenige wissen: Munch und Kapitän Scheel kannten sich gut.',
    introTextEn:
    ...
    storyTextDe:
      'In Munchs Atelier fand man eine alte Standuhr. Fischer berichten, Scheel habe sie auf eine bestimmte Uhrzeit gestellt — den Moment, in dem er das Haus an jenem Abend verließ. Die Zeiger zeigten auf eine praezise Zeit. Stellt die Uhr auf die richtige Zeit ein.',
    storyTextEn:
    ...
    completionTextDe:
      '19:23 — die Uhrzeit seines Aufbruchs! Munch notierte sie in seinem Tagebuch. Die Spur führt weiter zum Alten Strom.',
    completionTextEn:
      '19:23 — the time of his departure! Munch noted it in his diary. The trail continues to the Alter Strom.',
    transitionTextDe:
      'Vom Munch-Haus sind es nur wenige Meter bis zum Alten Strom — dem historischen Wasserweg, an dem bunte Fischkutter liegen. Hier hat Scheel in einem alten Fischerhaus einen verschlüsselten Brief hinterlegt.',
    transitionTextEn:
  ...
  // ── 10. Alter Strom ───────────────────────────────────────────────────
  {
    ...
    radiusMeters: 50,
    introTextDe:
      'Der Alte Strom ist das Herz von Warnemünde. Hier liegen bunte Fischkutter und die Luft riecht nach Räucherfisch. Doch hinter der malerischen Fassade verbirgt sich ein Rätsel...',
    introTextEn:
      'The Old Channel is the heart of Warnemuende. Colorful fishing boats line the banks and the air smells of smoked fish.',
    storyTextDe:
      'In einem alten Fischerhaus fand man ein zerbrochenes Bild — Scheels verschlüsselte Seekarte. Die Kacheln sind durcheinander geraten. Setzt das Bild zusammen, um zu sehen, was Scheel verborgen hat. Das Symbol auf dem fertigen Bild ist der Schlüssel.',
    storyTextEn:
    ...
    completionTextDe:
      'Fantastisch! Das Bild zeigt den Alten Strom von oben — und in der Mitte ein Symbol: einen Kompass. Der Brief enthält noch einen Zusatz: "Am Fischmarkt liegt mein letzter Bote — fragt die Fischer nach dem Knoten."',
    completionTextEn:
    ...
    walkingHintDe: 'Folgt dem Alten Strom nach Süden — der Fischmarkt liegt am Ende.',
  ...
  // ── 11. Fischmarkt ────────────────────────────────────────────────────
  {
    ...
    storyTextDe:
      'Die Fischer am Hafen kannten Scheel. Ihre Knoten-Sprache — jeder Knoten eine Botschaft — war sein letztes Kommunikationsmittel. Vier Knoten hängen am alten Poller: Palstek (P), Kreuzknoten (K), Achtknoten (A), Schotstek (S). Scheels Botschaft beginnt immer mit seinem Lieblingsknoten — dem Palstek. Danach der Kreuzknoten, dann der Schotstek, zuletzt der Achtknoten. Welches Wort ergibt sich?',
    storyTextEn:
    ...
    completionTextDe:
      'Die Knoten sprechen! PKSA — Scheels Botschaft ist fast vollständig. Der letzte Hinweis führt zum Bahnhof — dort, wo seine Spur endgueltig verschwand.',
    completionTextEn:
    ...
    transitionTextDe:
      'Scheels letzte dokumentierte Sichtung war am Bahnhof von Warnemünde. Der Fahrplan von 1923 enthält eine Anomalie — einen Zug, der nie existierte. Geht zum Bahnhof — es ist sein letztes Rätsel.',
    transitionTextEn:
  ...
  // ── 12. Bahnhof (Finale) ─────────────────────────────────────────────
  {
    ...
    subtitleDe: 'Das letzte Vermächtnis',
    subtitleEn: 'The final legacy',
    location: { lat: 54.1774, lng: 12.0904 },
    locationName: 'Bahnhof Warnemuende',
    radiusMeters: 50,
    introTextDe:
      'Der Bahnhof von Warnemünde — Endstation der Strecke aus Rostock und Tor zur Ostsee. Hier beginnen und enden Reisen. Fuer Kapitän Scheel endete hier alles.',
    introTextEn:
    ...
    storyTextDe:
      'Der Fahrplan von 1923 zeigt einen raetselhaften Eintrag: Geisterzug, Gleis 0. Scheel hinterließ einen 6-stelligen Code als Abfahrtszeit. Die ersten zwei Ziffern: das Jahrhundert, in dem die Vogtei erbaut wurde. Die mittleren zwei: Scheels Ernennung zum Lotsenkapitän minus 1900. Die letzten zwei: die Hausnummer des Munch-Hauses. Kombiniert euer Wissen!',
    storyTextEn:
    ...
    completionTextDe:
      'Glückwunsch! Ihr habt das vollständige Vermächtnis des Lotsenkapitäns entschlüsselt!\n\nScheels letzte Botschaft lautet: "Warnemünde lebt in denen weiter, die es mit offenen Augen erkunden. Ich bin nicht verschwunden — ich bin überall hier."\n\nGeht zurück zum Leuchtturm, wo alles begann. Eure Tour endet dort, wo sie angefangen hat — bei Shoes Please.',
    completionTextEn:
...
export const DEMO_PUZZLES: readonly Puzzle[] = [
  // 1. Leuchtturm — Zaehlen (easy)
  {
    ...
    puzzleType: 'count',
    difficulty: 'easy',
    questionDe: 'Wie viele Stufen hat der Leuchtturm von Warnemünde?',
  ...
  // 2. Teepott — Foto-Suche (easy)
  {
    ...
    instructionDe: 'Schaut nach oben — die Wetterfahne auf dem Dach zeigt ein typisches Küsten-Tier.',
  ...
  // 3. Westmole — Kombination (easy)
  {
    ...
    difficulty: 'easy',
    questionDe: 'Am grünen Leuchtfeuer hat Kapitän Scheel eine Jahreszahl eingeritzt — das Jahr, in dem er Lotsenkapitän wurde. Gebt den 4-stelligen Code ein.',
  ...
  // 4. Kurhaus — Dokumenten-Analyse (medium)
  {
    ...
    difficulty: 'medium',
    questionDe: 'Über dem Eingangsportal des Kurhauses steht eine Inschrift. Welche vierstellige Jahreszahl findet ihr dort?',
    questionEn: 'Above the entrance portal of the Kurhaus is an inscription. What four-digit year can you find there?',
    instructionDe: 'Schaut über die Haupttuer — die Zahl ist in Stein gemeißelt.',
  ...
  // 5. Strand — Kombination (medium)
  {
    ...
    puzzleType: 'combination',
    difficulty: 'medium',
    questionDe: 'Gebt den 4-stelligen Code ein, um die Truhe zu öffnen. Die Kombination ist das Gründungsjahr des Warnemünder Leuchtturms.',
  ...
  // 6. Kirchplatz — Symbol-Suche (medium)
  {
    ...
    difficulty: 'medium',
    questionDe: 'Welches Symbol der Seefahrer findet sich an der Kirchentür? Gebt den Namen des Symbols ein.',
    questionEn: 'Which seafarer symbol can be found on the church door? Enter the name of the symbol.',
    instructionDe: 'Es ist ein schweres Eisengerät, das Schiffe am Meeresgrund hält.',
  ...
  // 7. Heimatmuseum — Akrostichon (medium) — Antwort: LOTSE (nicht ANKER)
  {
    ...
    difficulty: 'medium',
    questionDe: 'Im Inventarverzeichnis stehen fünf Einträge: Leuchtturm, Ostsee, Teepott, Segel, Ebbe. Welches Wort ergeben die Anfangsbuchstaben?',
  ...
  // 8. Vogtei — Siegel-Code (hard)
  {
    ...
    puzzleType: 'combination',
    difficulty: 'hard',
    questionDe: 'Die fünf Siegel an der Fassade stehen für Zahlen: Anker=1, Kreuz=2, Stern=3, Welle=4, Krone=5. Von links nach rechts seht ihr: Stern, Anker, Krone, Welle, Kreuz. Gebt den 5-stelligen Code ein.',
  ...
  // 9. Munch-Haus — Uhr-Rätsel (hard) — Wann verließ Scheel das Haus?
  {
    id: 'demo-puzzle-009',
    ...
    puzzleType: 'clock',
    difficulty: 'hard',
    questionDe: 'Um welche Uhrzeit verließ Kapitän Scheel an jenem Abend das Munch-Haus? Stellt die Uhr auf die richtige Zeit ein.',
    questionEn: 'What time did Captain Scheel leave the Munch house that evening? Set the clock to the correct time.',
    instructionDe: 'Scheels Verschwinden wurde 1923 dokumentiert. Er verließ das Haus abends — die Uhrzeit enthält dieselbe Zahl wie das Jahr.',
  ...
  // 10. Alter Strom — Schiebe-Puzzle (hard)
  {
    ...
    instructionDe: 'Setzt das Bild zusammen und gebt dann das Lösungswort ein. Es ist ein Navigationsgerät.',
  ...
  // 11. Fischmarkt — Knoten-Entschlüsselung (hard) — Text statt MC
  {
    id: 'demo-puzzle-011',
    ...
    puzzleType: 'text_analysis',
    difficulty: 'hard',
    questionDe: 'Vier Knoten hängen am Poller: Palstek (P), Kreuzknoten (K), Achtknoten (A), Schotstek (S). Scheels Botschaft beginnt immer mit dem Palstek, danach der Kreuzknoten, dann der Schotstek, zuletzt der Achtknoten. Gebt die vier Buchstaben als Wort ein.',
  ...
  // 12. Bahnhof — Meta-Puzzle Finale (finale)
  {
    ...
    puzzleType: 'combination',
    difficulty: 'finale',
    questionDe: 'Der Geisterzug braucht einen 6-stelligen Abfahrtscode. Die ersten zwei Ziffern: das Jahrhundert, in dem die Vogtei erbaut wurde. Die mittleren zwei: Scheels Ernennung zum Lotsenkapitän minus 1900. Die letzten zwei: die Hausnummer des Munch-Hauses. Kombiniert euer Wissen!',
...
export const DEMO_HINTS: ReadonlyMap<string, readonly DemoHint[]> = new Map([
  ...
  [
    ...
    [
      ...
      { id: 'hint-002-2', puzzle_id: 'demo-puzzle-002', hint_level: 2, text_de: 'Es ist ein Küsten-Vogel, der für seine lauten Schreie bekannt ist.', text_en: 'It is a coastal bird known for its loud calls.', point_penalty: 30, time_bonus_penalty_percent: 50, marks_as_skipped: false, available_after_seconds: 60 },
      { id: 'hint-002-3', puzzle_id: 'demo-puzzle-002', hint_level: 3, text_de: 'M-O-E-W-E. Fuenf Buchstaben, typisch für die Ostsee.', text_en: 'S-E-A-G-U-L-L. Typical for the Baltic Sea.', point_penalty: 50, time_bonus_penalty_percent: 100, marks_as_skipped: false, available_after_seconds: 90 },
    ],
  ],
  [
    'demo-puzzle-003',
  ...
  [
    ...
    [
      ...
      { id: 'hint-006-2', puzzle_id: 'demo-puzzle-006', hint_level: 2, text_de: 'Es ist schwer, aus Eisen, und hält am Meeresgrund. 5 Buchstaben.', text_en: 'It is heavy, made of iron, and holds to the seabed. 6 letters.', point_penalty: 50, time_bonus_penalty_percent: 50, marks_as_skipped: false, available_after_seconds: 45 },
  ...
  [
    ...
    [
      ...
      { id: 'hint-007-2', puzzle_id: 'demo-puzzle-007', hint_level: 2, text_de: 'Das Wort beschreibt jemanden, der Schiffe sicher in den Hafen führt.', text_en: 'The word describes someone who guides ships safely into port.', point_penalty: 50, time_bonus_penalty_percent: 50, marks_as_skipped: false, available_after_seconds: 45 },
  ...
  [
    ...
    [
      ...
      { id: 'hint-008-3', puzzle_id: 'demo-puzzle-008', hint_level: 3, text_de: 'Der vollständige Code lautet 31542.', text_en: 'The complete code is 31542.', point_penalty: 100, time_bonus_penalty_percent: 100, marks_as_skipped: false, available_after_seconds: 90 },
    ],
  ],
  [
    'demo-puzzle-009',
  ...
  [
    ...
    [
      ...
      { id: 'hint-012-3', puzzle_id: 'demo-puzzle-012', hint_level: 3, text_de: 'Der vollständige Code lautet 130353.', text_en: 'The complete code is 130353.', point_penalty: 150, time_bonus_penalty_percent: 100, marks_as_skipped: false, available_after_seconds: 90 },
    ],
  ],
])
...
export const DEMO_CERTIFICATE: Certificate = {
  ...
  teamName: 'Demo Team',
  tourName: 'Das Vermächtnis des Lotsenkapitäns',
  variant: 'adult',
  date: NOW,
  stats: {
    totalPoints: 2000,
