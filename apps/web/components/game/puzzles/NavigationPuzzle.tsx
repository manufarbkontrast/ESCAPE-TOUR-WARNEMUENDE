...
export function NavigationPuzzle({ puzzle, language, onSubmit, isSubmitting, isDemo = false }: NavigationPuzzleProps) {
 ...
 if (!target) {
  return <p className="text-center text-sm text-white/70 font-semibold">{noTargetMessage}</p>
 }
 ...
 return (
  <div className="space-y-5">
   ...
   <div className="flex flex-col items-center gap-4 rounded-lg border-2 border-white/10 bg-dark-800/60 backdrop-blur-sm p-6">
    {/* Compass Arrow */}
