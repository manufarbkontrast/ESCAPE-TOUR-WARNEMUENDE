      ...
      <div className="flex justify-center gap-3">
        {digits.map((digit, index) => (
          <input
            ...
            className="h-16 w-14 rounded-lg border-2 border-brass-500 bg-navy-900 text-center text-3xl font-bold text-brass-400 shadow-xl transition-all focus:border-brass-400 focus:outline-none focus:ring-2 focus:ring-brass-400/50 disabled:opacity-50"
            autoComplete="off"
