      ...
      <div className="flex justify-center gap-3">
        {digits.map((digit, index) => (
          <input
            ...
            className="h-16 w-14 rounded-lg border-2 border-white/20 bg-navy-900 text-center text-3xl font-bold text-white shadow-xl transition-all focus:border-white/60 focus:outline-none focus:ring-2 focus:ring-white/30 disabled:opacity-50"
            autoComplete="off"
