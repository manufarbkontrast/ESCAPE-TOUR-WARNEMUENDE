...
const STEPS: readonly OnboardingStep[] = [
  {
    ...
    descriptionDe: 'Folgt der Karte zu den markierten Stationen in Warnemünde. Die gelbe Markierung zeigt euch, wo ihr als nächstes hin müsst.',
    descriptionEn: 'Follow the map to marked stations across Warnemünde. The yellow marker shows where to go next.',
    accentColor: 'rgba(237, 170, 59, 0.9)',
    accentGlow: 'rgba(237, 170, 59, 0.15)',
  },
  {
    icon: Compass,
